...
public class resultado_3 extends AppCompatActivity {
    ...
    private  TextView Vel_lopmon;
    private TextView Vel_inimigo_3;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.resultado_3);
        ...
        Vel_lopmon = (TextView) findViewById(R.id.Vel_lopmon);
        Vel_inimigo_3 = (TextView) findViewById(R.id.Vel_inimigo_3);
        //
        Intent i = getIntent();
        ...
        Vel_inimigo_3.setText(pao);
        Vel_lopmon.setText(pao);
