...
public class resultado_1 extends AppCompatActivity {
    ...
    private  TextView Vel_agumon;
    private TextView Vel_inimigo;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.resultado_1);
        ...
        Vel_agumon = (TextView) findViewById(R.id.Vel_agumon);
        Vel_inimigo = (TextView) findViewById(R.id.Vel_inimigo);
        //
        Intent i = getIntent();
        ...
        Vel_inimigo.setText(pao);
        Vel_agumon.setText(pao);
